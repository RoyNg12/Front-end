...
<div class="user-profile">
   ...
   <div class="flex">
      ...
      <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are your sure you want to logout?');" class="delete-btn2">logout</a>
      <a href="update_profile.php" class="btn2">Update Profile</a>
...
<div class="products">
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <a href="product_details.php?id=<?php echo $fetch_product['id'];?>" class="btn1">View</a>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn2" onclick="return confirm('remove item from cart?');">remove</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('delete all from cart?');" class="delete-btn2 <?php echo ($grand_total > 1)?'':'disabled'; ?>">delete all</a></td>
      </tr>
   </tbody>
   </table>
